...
img = cv2.imread('resources/testing/8.jpeg')
img_copy = img.copy()

only_gray, img_copy = extract_color(img_copy, np.array([0, 0, 40]), np.array([180, 60, 230]))
...
shapes, contour_image = find_contours(img_copy)
...
# shapes = {**shapes}#, **blue_shapes, **yellow_shapes, **orange_shapes, **white_shapes, **brown_shapes, **red_shapes}
